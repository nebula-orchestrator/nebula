...
3. create your copy of the api-manger docker image, a base image is available at [docker-hub](https://hub.docker.com/r/nebula-orchestrator/nebula/) with the "api-manager" tag (example: `docker pull nebula-orchestrator/nebula:api-manager`), either use it as a baseline FROM to create your own image or mount your own config file to replace the default one
...
5. create your copy of the worker-manger docker image, a base image is available at docker hub at [docker-hub](https://hub.docker.com/r/nebula-orchestrator/nebula/) with the "worker-manager" tag (example: `docker pull nebula-orchestrator/nebula:worker-manager`), either use it as a baseline FROM to create your own image or mount your own config file to replace the default one
