...
def rabbit_connect(rabbit_user, rabbit_pass, rabbit_host, rabbit_port, rabbit_virtual_host):
    try:
        ...
        print "rabbit_connect issue - dropping container due to rabbit connection issues"
        os._exit(2)
...
def rabbit_close(rabbit_connection):
    try:
        ...
        print "rabbit close issue - dropping container due to rabbit connection issues"
        os._exit(2)
...
def rabbit_create_channel(rabbit_connection):
    try:
        ...
        print "rabbit create channel issue - dropping container due to rabbit connection issues"
        os._exit(2)
...
def rabbit_create_exchange(rabbit_channel, exchange_name):
    try:
        ...
        print "rabbit create exchange issue - dropping container due to rabbit connection issues"
        os._exit(2)
...
def rabbit_send(rabbit_channel, exchange_name, rabbit_send_message):
    try:
        ...
        print "rabbit send issue - dropping container due to rabbit connection issues"
        os._exit(2)
...
def rabbit_receive(rabbit_receive_channel, rabbit_work_function, rabbit_receive_queue):
    try:
        ...
        print "rabbit receive issue - dropping container due to rabbit connection issues"
        os._exit(2)
...
def rabbit_ack(rabbit_ack_channel, rabbit_ack_method):
    try:
        ...
        print "rabbit ack issue - dropping container due to rabbit connection issues"
        os._exit(2)
...
def rabbit_create_queue(rabbit_queue_name, rabbit_channel):
    try:
        ...
        print "rabbit create queue issue - dropping container due to rabbit connection issues"
        os._exit(2)
...
def rabbit_bind_queue(rabbit_bind_queue_name, rabbit_bind_channel, rabbit_bind_exchange):
    try:
        ...
        print "rabbit bind queue issue - dropping container due to rabbit connection issues"
        os._exit(2)
